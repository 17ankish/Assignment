...
def NNmodel(last_iteration, alpha):
...
#        y = (a[:, -2:]).T
        ...
        error, delta1, delta2, delta3 = backward_pass(a1, a2, a3, w1, w2, w3, y)
...
last_iteration = 0
alpha_list = [0.9, 0.5, 0.1, 0.01]
for alpha in alpha_list:
    w1, w2, w3, error_list, last_iteration = NNmodel(last_iteration, alpha)
    plt.figure()
